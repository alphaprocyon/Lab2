        ...
        while (true)
        {
            ...
            switch (command)
            {
                ...
                case "color":
                    if (parts.Length < 2)
                    {
                        Console.WriteLine("Please specify a color black.");
                    }
                    else
                    {
                        ...
                        {
                            Console.WriteLine("Please use black.");
                        }
                    }
                    break;
                case "list":
                    if (parts.Length < 2)
                    {
                        Console.WriteLine("Please specify 'steps' or 'figures'.");
                    }
                    else
                    {
                        ...
                        {
                            Console.WriteLine("Please use 'steps' or 'figures'.");
                        }
                    }
                    break;
                default:
                    Console.WriteLine("Please use one of the supported commands.");
                    break;
            }
        }
    }
